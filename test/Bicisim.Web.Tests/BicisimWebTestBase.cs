...
{
    public abstract class BicisimWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BicisimWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BicisimWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BicisimDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BicisimDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BicisimDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BicisimDbContext, Task<T>> func)
        {
            T result;
